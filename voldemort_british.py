...
def prep_words(name, word_list_ini):
    ...
    print("Length of new word list = {}".format(len(word_list)))
    return word_list
...
def cv_map_filter(name, filtered_cv_map):
    """Remove permutations of words based on unlikely c-v combinations"""
    ...
    print("Number of choices after filter_1 = {}".format(len(filter_1)))
    return filter_1
...
def digram_filter(filter_2):
    ...
    print("Number of choices after filter_3 = {}".format(len(filter_3)))
